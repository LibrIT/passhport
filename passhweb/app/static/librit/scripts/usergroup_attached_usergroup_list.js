$(document).ready(function () {
    ...
    var attachedusergroupurl = "/ajax/attached/usergroup/usergroups/";
    ...
    $('#attachedusergroups').DataTable({
        ...
        'deferRender' : true,
        "language": {
            "emptyTable": "No usergroup is attached to this usergroup"
        },
        columnDefs: [ {
            targets: "nosort",
            "orderable": false,
        ...
        'ajax'        : {
            url     : attachedusergroupurl.concat(usergroupname),
            dataSrc : 'data'
        }
    })    

    // Ask to validate before removing usergroup from usergroup
    $('#attachedusergroups tbody').on( 'click', '#deleteclose', function () {
        ...
        if (span.innerText != "Undo") {
            ...
            $.ajax({
                url: '/ajax/addrm/rm/usergroup/usergroup',
                type: 'post',
                data: {"subusergroupname" : name, "usergroupname": usergroupname},
                success: function() {
                    // Graphical hints
                    span.innerText = "Undo"
            ...
            $.ajax({
                url: '/ajax/addrm/add/usergroup/usergroup',
                type: 'post',
                data: {"subusergroupname" : name, "usergroupname" : usergroupname},
                success: function() {
                    // Graphical hints
