...
def prompt_targetgroup_edit():
    ...
    targetgroupname = pyt_compat.input_compat(
        "Name of the targetgroup you want to modify: ")
    ...
    if req.requests_targetgroup_show(targetgroupname) == 0:
        ...
        return req.requests_targetgroup_edit(
            targetgroupname,
            new_targetgroupname,
            new_comment)
...
def prompt_targetgroup_addusergroup(usergroupname, targetgroupname):
    ...
    return req.requests_targetgroup_addusergroup(
        usergroupname,
        targetgroupname)
...
def prompt_targetgroup_addtargetgroup(subtargetgroupname, targetgroupname):
    ...
    return req.requests_targetgroup_addtargetgroup(
        subtargetgroupname,
        targetgroupname)
...
def prompt_targetgroup_rmtargetgroup(subtargetgroupname, targetgroupname):
    ...
    return req.requests_targetgroup_rmtargetgroup(
        subtargetgroupname,
        targetgroupname)
