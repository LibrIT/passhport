...
def prompt_usergroup_edit():
    ...
    usergroupname = pyt_compat.input_compat(
        "Name of the usergroup you want to modify: ")
    ...
    if req.requests_usergroup_show(usergroupname) == 0:
        ...
        return req.requests_usergroup_edit(
            usergroupname,
            new_usergroupname,
            new_comment)
...
def prompt_usergroup_rmusergroup(subusergroupname, usergroupname):
    """Remove a usergroup (subusergroup) from a usergroup"""
    return req.requests_usergroup_rmusergroup(subusergroupname, usergroupname)
