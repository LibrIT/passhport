...
class TestUser:
    ...
    def test_create(self):
        ...
        u = user.User(email = email.encode("utf8"), sshkey = sshkey.encode("utf8"), comment = comment.encode("utf8"))
        db.session.add(u)
        db.session.commit()

        u_db = db.session.query(user.User).filter_by(email = "john@example.com".encode("utf8")).first()
    ...
    def test_create_existing_email(self):
        ...
        u = user.User(email = email.encode("utf8"), sshkey = """Another sshkey""".encode("utf8"), comment = comment.encode("utf8"))
        db.session.add(u)
        db.session.commit()
    ...
    def test_create_existing_sshkey(self):
        ...
        u = user.User(email = "smith@example.com".encode("utf8"), sshkey = sshkey.encode("utf8"), comment = comment.encode("utf8"))
        db.session.add(u)
        db.session.commit()
    ...
    def test_edit(self):
        ...
        user_to_edit = db.session.query(user.User).filter_by(email = "example@test.org".encode("utf8"))
        updated_rows = user_to_edit.update({"email": new_email.encode("utf8"), "sshkey": new_sshkey.encode("utf8"), "comment": new_comment.encode("utf8")})
        db.session.commit()

        u_edit = db.session.query(user.User).filter_by(email = new_email.encode("utf8")).first()
    ...
    def test_edit_non_existing_user(self):
        ...
        u            = db.session.query(user.User).filter_by(email = "random@alea.info".encode("utf8"))
        updated_rows = u.update({"email": "bat@man.com".encode("utf8"), "sshkey": "batmobile".encode("utf8"), "comment": "So d4rk".encode("utf8")})
    ...
    def test_edit_existing_email(self):
        ...
        u  = user.User(email = email.encode("utf8"), sshkey = sshkey.encode("utf8"), comment = comment.encode("utf8"))
        u2 = user.User(email = email2.encode("utf8"), sshkey = sshkey2.encode("utf8"), comment = comment2.encode("utf8"))
    ...
    def test_show(self):
        ...
        user_data = user.User.query.filter_by(email = email.encode("utf8")).first()
    ...
    def test_show_non_existing_user(self):
        ...
        user_data = user.User.query.filter_by(email = "the@mail.net".encode("utf8")).first()
    ...
    def test_search(self):
        ...
        query = db.session.query(user.User.email).filter(user.User.email.like('%' + ".net" + '%')).all()
