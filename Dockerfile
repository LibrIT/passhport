...
RUN echo "    " && su - passhport -c "git clone http://github.org/Raphux/passhport.git"
...
RUN mkdir /etc/passhport && sed -e 's/^HOST =.*/HOST = 0.0.0.0/' /home/passhport/passhport/passhportd/passhport.ini > /etc/passhport/passhport.ini
